...
public class MainController {
    ...
    public MainController(Stage stage) throws IOException {
        ...
        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("/views/resources/icon.png")));
    ...
    public void changeScene(int view) throws IOException {
        ...
        switch(view){
            case PAGE_MAIN : loader = new FXMLLoader(getClass().getResource("/views/MainMenu.fxml"));
                game = new TicTacToe(turn);
                break;
            case PAGE_BOARD: loader = new FXMLLoader(getClass().getResource("/views/Board.fxml"));
                break;
            case PAGE_CREDITS: loader = new FXMLLoader(getClass().getResource("/views/Credits.fxml"));
                break;
        }
