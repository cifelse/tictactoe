...
public class BoardController extends Controller{
    ...
    private void getComputerMove(){
        ...
        if (!blank){
            ...
            blank = true;
            imageText1.setImage(new Image(getClass().getResourceAsStream("/views/resources/turn1.png")));
    ...
    private void checkElement(){
        if(controller.getGame().getCurrentElement() == 'X'){
            element = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/X.png")));
        }
        else
            element = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/O.png")));
    }
        ...
        if (result.getKey()){
            ...
            if(!result.getValue()){
                if((controller.getTurn() == 1 && controller.getGame().getWinningLetter() == 'X') || (controller.getTurn() == 0 && controller.getGame().getWinningLetter() == 'O') ){
                    imageText3.setImage(new Image(getClass().getResourceAsStream("/views/resources/humanWins.png")));
                }
                else{
                    imageText3.setImage(new Image(getClass().getResourceAsStream("/views/resources/aiWins.png")));
                }

            }
            else {
                imageText3.setImage(new Image(getClass().getResourceAsStream("/views/resources/draw.png")));
            }

            imageText1.setImage(new Image(getClass().getResourceAsStream("/views/resources/gameOver.png")));
    ...
    public void againButtonIn() {
        sfx.getMediaPlayer().play();
        againButton.setImage(new Image(getClass().getResourceAsStream("/views/resources/againButton_Hovered.png")));
    }

    @FXML
    public void againButtonOut() {
        againButton.setImage(new Image(getClass().getResourceAsStream("/views/resources/againButton.png")));
    }

    @FXML
    public void startButtonIn() {
        sfx.getMediaPlayer().play();
        imageText2.setImage(new Image(getClass().getResourceAsStream("/views/resources/startButton_Hovered.png")));
    }

    @FXML
    public void startButtonOut() {
        imageText2.setImage(new Image(getClass().getResourceAsStream("/views/resources/startButton.png")));
    }
